...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    _______ , _______    , LT(3,KC_W)   , LT(4,KC_E)   , LT(5,KC_R)   , _______   , _______  , LT(6,KC_U)    , LT(7,KC_I)      , LT(8,KC_O)     , _______    , _______ , _______ , _______ , _______ ,
  ...
  [2] = LAYOUT(
    ...
    RESET   , XXXXXXX    , XXXXXXX      , MEH(KC_SPC)  , KC__VOLDOWN  , KC__VOLUP , KC__MUTE , XXXXXXX       , XXXXXXX         , XXXXXXX        
  ),
  [3] = LAYOUT(
