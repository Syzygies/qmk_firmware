...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [5] = LAYOUT(
    ...
    XXXXXXX      , KC_GRV      , KC_LPRN    , KC_RPRN    , KC_UNDS    , KC_CIRC    , KC_AMPR , KC_MINS    , KC_EQL      , KC_PLUS    , KC_COLN        , XXXXXXX , KC_ENT  ,
  ...
  [6] = LAYOUT(
    ...
    XXXXXXX      , KC_6        , KC_7       , KC_8       , KC_9       , KC_0       , KC_LEFT , KC_DOWN    , KC_UP       , KC_RGHT    , XXXXXXX        , XXXXXXX , KC_ENT  ,
