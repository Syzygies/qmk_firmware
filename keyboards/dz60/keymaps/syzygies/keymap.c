...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_60_ansi(
    ...
    TG(1)   , XXXXXXX    , KC_UP        , XXXXXXX      , XXXXXXX      , BL_INC  , RGB_M_P , RGB_HUD       , RGB_HUI         , XXXXXXX        , XXXXXXX    , XXXXXXX     , XXXXXXX   , RESET   ,
    XXXXXXX , KC_LEFT    , KC_DOWN      , KC_RGHT      , XXXXXXX      , BL_TOGG , RGB_TOG , RGB_SAD       , RGB_SAI         , XXXXXXX        , XXXXXXX    , XXXXXXX     , XXXXXXX   ,
