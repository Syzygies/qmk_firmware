...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_60_ansi(
    KC_GRV  , KC_1       , KC_2         , KC_3         , KC_4         , KC_5    , KC_6    , KC_7          , KC_8            , KC_9           , KC_0       , KC_MINS     , KC_EQL    , LT(4,KC_BSPC) ,
    KC_TAB  , KC_Q       , KC_W         , LT(3,KC_E)   , LT(2,KC_R)   , KC_T    , KC_Y    , LT(2,KC_U)    , LT(3,KC_I)      , KC_O           , KC_P       , KC_LBRC     , KC_RBRC   , KC_BSLS       ,
  ...
  [4] = LAYOUT_60_ansi(
    ...
    DF(0)   , DF(1)      , XXXXXXX      , MEH(KC_SPC)  , XXXXXXX      , XXXXXXX , XXXXXXX , RESET         
  ),
  // FJ
  [5] = LAYOUT_60_ansi(
