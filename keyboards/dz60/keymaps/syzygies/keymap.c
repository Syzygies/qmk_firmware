...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // Safety
  [0] = LAYOUT_60_ansi(
    KC_GRV  , KC_1       , KC_2         , KC_3         , KC_4         , KC_5        , KC_6    , KC_7          , KC_8            , KC_9           , KC_0       , KC_MINS     , KC_EQL    , LT(4,KC_BSPC) ,
  ...
  [1] = LAYOUT_60_ansi(
    KC_GRV  , KC_1       , KC_2         , KC_3         , KC_4         , KC_5        , KC_6    , KC_7          , KC_8            , KC_9           , KC_0       , KC_MINS     , KC_EQL    , LT(4,KC_BSPC) ,
    KC_TAB  , KC_Q       , LT(4,KC_W)   , LT(3,KC_E)   , LT(2,KC_R)   , KC_T        , KC_Y    , LT(2,KC_U)    , LT(3,KC_I)      , LT(4,KC_O)     , KC_P       , KC_LBRC     , KC_RBRC   , KC_BSLS       ,
  ...
  [2] = LAYOUT_60_ansi(
    ...
    XXXXXXX , MEH(KC_Z)  , MEH(KC_X)    , MEH(KC_C)    , MEH(KC_V)    , MEH(KC_B)   , XXXXXXX , XXXXXXX       , XXXXXXX         , XXXXXXX        , XXXXXXX    , XXXXXXX     ,
  ...
  [4] = LAYOUT_60_ansi(
    ...
    DF(0)   , DF(1)      , XXXXXXX      , XXXXXXX      , XXXXXXX      , XXXXXXX     , XXXXXXX , RESET         
  ),
  // FJ
  [5] = LAYOUT_60_ansi(
