...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_60_ansi(
    _______ , _______    , _______      , _______      , _______      , _______ , _______ , _______       , _______         , _______        , _______    , _______     , _______   , LT(2,KC_BSPC) ,
    _______ , _______    , LT(5,KC_W)   , LT(6,KC_E)   , LT(7,KC_R)   , _______ , _______ , LT(8,KC_U)    , LT(9,KC_I)      , LT(10,KC_O)    , _______    , _______     , _______   , _______       ,
  ...
  [2] = LAYOUT_60_ansi(
    ...
    XXXXXXX , XXXXXXX    , KC_UP        , XXXXXXX      , XXXXXXX      , BL_INC  , RGB_M_P , RGB_HUD       , RGB_HUI         , XXXXXXX        , XXXXXXX    , XXXXXXX     , XXXXXXX   , XXXXXXX       ,
    TG(1)   , KC_LEFT    , KC_DOWN      , KC_RGHT      , XXXXXXX      , BL_TOGG , RGB_TOG , RGB_SAD       , RGB_SAI         , XXXXXXX        , XXXXXXX    , XXXXXXX     , RESET     ,
